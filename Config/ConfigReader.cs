...
namespace SRSAutoFramework.Config
{
    public class ConfigReader
    {
        public static void SetFrameworkSettings()
        {
            ...
            Settings.SRSEHRBuildVersion = ConfigurationManager.AppSettings["SRSEHRBuildVersion"];
            Settings.SRSMobileBuildVersion = ConfigurationManager.AppSettings["SRSMobileBuildVersion"];
